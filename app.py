...
<div class="main-header">
    ...
    <p>Tác giả: Đặng Văn Vương - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0819335556</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đặng Văn Vương - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0819335556</div>", unsafe_allow_html=True)
